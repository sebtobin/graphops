...
/* Create a new hash table and return a hashTable_t pointer
 * PARAMS:
...
/* Insert data into the hash table, returns the linked list node for the data,
 ...
 * containing *data from the table, frees the contained data ptr as well
 * PARAMS:
...
/* Frees a hashtable and the contained array of pointers, including the data
 * PARAMS:
